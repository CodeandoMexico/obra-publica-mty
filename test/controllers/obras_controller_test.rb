...
class ObrasControllerTest < ActionController::TestCase
  ...
  test "should create obra" do
    assert_difference('Obra.count') do
      post :create, obra: { avance: @obra.avance, monto: @obra.monto, name: @obra.name, status: @obra.status }
    end
  ...
  test "should update obra" do
    patch :update, id: @obra, obra: { avance: @obra.avance, monto: @obra.monto, name: @obra.name, status: @obra.status }
    assert_redirected_to obra_path(assigns(:obra))
  end
